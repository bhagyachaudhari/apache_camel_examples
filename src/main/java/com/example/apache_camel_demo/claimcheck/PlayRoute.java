/*
package com.example.apache_camel_demo.claimcheck;
...
public class PlayRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        intercept().to("log:msg>>");
        //intercept().when(body().contains("secrete")).stop();
        //interceptSendToEndpoint("mock:step-3").to("log:msg>>>");
        //interceptSendToEndpoint("mock:step-3").skipSendToOriginalEndpoint();
        // spotless:off
        from("direct:start")
                .to("mock:step-1")
